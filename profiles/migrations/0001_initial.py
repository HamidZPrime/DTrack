    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_picture', models.ImageField(blank=True, null=True, upload_to='profiles/pictures/', verbose_name='Profile Picture')),
                ...
                ('company_registration_number', models.CharField(blank=True, max_length=50, verbose_name='Company Registration Number')),
                ('vat_number', models.CharField(blank=True, max_length=50, verbose_name='VAT Number')),
                ('supplier_type', models.CharField(blank=True, help_text='E.g., Manufacturer, Distributor', max_length=50, verbose_name='Supplier Type')),
                ...
                ('operator_level', models.PositiveIntegerField(default=1, help_text='1-5, with 5 being the highest rank.', validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(5)], verbose_name='Operator Level')),
                ('preferred_language', models.CharField(choices=[('en', 'English'), ('ar', 'Arabic')], default='en', max_length=5, verbose_name='Preferred Language')),
                ('interests', models.TextField(blank=True, help_text='E.g., Jewelry, Gold, Fashion', verbose_name='Interests')),
