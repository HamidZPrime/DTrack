...
class TaskCondition(models.Model):
    ...
    condition_type = models.CharField(
        _("Condition Type"), max_length=50, choices=CONDITION_TYPE_CHOICES
    )
    operator = models.CharField(_("Operator"), max_length=20, choices=OPERATOR_CHOICES)
    value = models.CharField(
        _("Value"), max_length=255, help_text=_("Value to compare with")
    )
...
class ScheduledTask(models.Model):
    ...
    task_type = models.CharField(
        _("Task Type"), max_length=50, choices=TASK_TYPE_CHOICES
    )
    ...
    created_by = models.ForeignKey(
        CustomUser, on_delete=models.SET_NULL, null=True, verbose_name=_("Created By")
    )
    ...
    def get_users_for_task(self):
        ...
        if self.task_type == "certificate_expiry":
            ...
            expiry_dates = [
                ...
                for days in self.custom_dates.get("days", [])
            ]
