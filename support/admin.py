...
class TicketCategoryAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ("date_created",)
    fieldsets = (
        (None, {"fields": ("department", "name", "description")}),
        (
            _("Important Dates"),
            {
                "fields": ("date_created",),
...
class TicketAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ("date_created", "last_updated")
    fieldsets = (
        (None, {"fields": ("supplier", "title", "description")}),
        (_("Department and Category"), {"fields": ("department", "category")}),
        (
            _("Ticket Details"),
            {"fields": ("status", "priority", "assigned_to", "sla_due_date")},
        ),
        (_("Important Dates"), {"fields": ("date_created", "last_updated")}),
    )
