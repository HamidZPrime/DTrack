...
class NotificationMethod(models.Model):
    ...
    method = models.CharField(
        _("Notification Method"), max_length=20, choices=METHOD_CHOICES, unique=True
    )
...
class NotificationRule(models.Model):
    ...
    trigger = models.CharField(
        _("Trigger"), max_length=50, choices=RULE_TRIGGER_CHOICES
    )
    ...
    condition = models.CharField(
        ...
        max_length=255,
        blank=True,
        help_text=_("Custom condition logic, e.g., 'expiry_date < today + 3 months'"),
    )
    is_active = models.BooleanField(_("Is Active"), default=True)
    priority = models.PositiveIntegerField(
        _("Priority"),
        default=1,
        help_text=_("Higher numbers indicate higher priority."),
    )
...
class NotificationHistory(models.Model):
    ...
    status = models.CharField(
        _("Status"),
        max_length=20,
        choices=[("sent", _("Sent")), ("failed", _("Failed"))],
        default="sent",
    )
...
class NotificationSchedule(models.Model):
    ...
    schedule_time = models.DateTimeField(
        _("Schedule Time"), help_text=_("Time to send the notification")
    )
    ...
    recurrence_interval = models.PositiveIntegerField(
        ...
        default=0,
        help_text=_("Interval in days for recurring notifications"),
    )
