    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("reminder", "Reminder"),
                            ("custom", "Custom Rule"),
                            ("email_verification", "Email Verification Reminder"),
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Custom condition logic, e.g., 'expiry_date < today + 3 months'",
                        max_length=255,
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=1,
                        help_text="Higher numbers indicate higher priority.",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="notification_templates.emailtemplate",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="notification_rules",
                        to="notification_templates.voicetemplate",
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        help_text="Time to send the notification",
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=0,
                        help_text="Interval in days for recurring notifications",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "voice_notifications",
                    models.BooleanField(
                        default=False, verbose_name="Voice Notifications"
                    ),
                ),
                (
                    "preferred_language",
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["user"], name="notificatio_user_id_93d024_idx"
                    ),
                    models.Index(
                        fields=["method"], name="notificatio_method__0243cb_idx"
                    ),
                    models.Index(
                        fields=["status"], name="notificatio_status_a89757_idx"
                    ),
                ],
            },
        ),
