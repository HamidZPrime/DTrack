...
class ApprovalRequestAdmin(admin.ModelAdmin):
    list_display = ('requester', 'entity_type', 'entity_id', 'status', 'reviewed_by', 'request_time')
...
class ApprovalLogAdmin(admin.ModelAdmin):
    list_display = ('approval_request', 'previous_status', 'new_status', 'action_taken_by', 'action_time')
    ...
    fieldsets = (
        (None, {
            'fields': ('approval_request', 'previous_status', 'new_status', 'action_taken_by', 'comments')
        }),
        ('Timestamps', {
            'fields': ('action_time',),
        }),
