...
class ApprovalRequest(models.Model):
    ...
    """
    requester = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='approval_requests', verbose_name=_("Requester"))
    entity_type = models.CharField(_("Entity Type"), max_length=50, choices=ApprovalType.choices)
    entity_id = models.PositiveIntegerField(_("Entity ID"))  # Entity ID refers to the primary key of the entity table
    status = models.CharField(_("Approval Status"), max_length=10, choices=ApprovalStatus.choices, default=ApprovalStatus.PENDING)
    reviewed_by = models.ForeignKey(CustomUser, on_delete=models.SET_NULL, null=True, blank=True, related_name='approvals_reviewed', verbose_name=_("Reviewed By"))
...
class ApprovalLog(models.Model):
    ...
    """
    approval_request = models.ForeignKey(ApprovalRequest, on_delete=models.CASCADE, related_name='logs', verbose_name=_("Approval Request"))
    previous_status = models.CharField(_("Previous Status"), max_length=10, choices=ApprovalStatus.choices)
    new_status = models.CharField(_("New Status"), max_length=10, choices=ApprovalStatus.choices)
    action_taken_by = models.ForeignKey(CustomUser, on_delete=models.SET_NULL, null=True, related_name='approval_actions', verbose_name=_("Action Taken By"))
