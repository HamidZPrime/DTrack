        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "origin_country",
                    models.CharField(
                        blank=True, max_length=50, verbose_name="Country of Origin"
                    ),
                ),
                (
                    "material_source",
                    models.CharField(
                        blank=True,
                        help_text="Where the materials are sourced from.",
                        max_length=255,
                        verbose_name="Material Source",
                    ),
                ),
                (
                    "carbon_footprint",
                    models.DecimalField(
                        blank=True,
                        decimal_places=2,
                        help_text="Carbon footprint in kg CO2 equivalent for the product's lifecycle.",
                        max_digits=10,
                        null=True,
                        validators=[django.core.validators.MinValueValidator(0)],
                        verbose_name="Carbon Footprint (kg CO2e)",
                    ),
                ),
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="A description of the product's lifecycle, from raw material extraction to end-of-life.",
                        verbose_name="Lifecycle Assessment",
                    ),
                ),
                (
                    "production_date",
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        help_text="Select from approved certificates.",
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(fields=["sku"], name="inventory_p_sku_f85905_idx"),
                    models.Index(
                        fields=["approval_status"],
                        name="inventory_p_approva_87f194_idx",
                    ),
                ],
            },
        ),
