...
from qr_generator.models import ProductQR  # Import QR code model for product integration
...
class Product(models.Model):
    ...
    category = models.ForeignKey(Category, on_delete=models.SET_NULL, null=True, related_name='products',
                                 verbose_name=_("Category"))
    tags = models.ManyToManyField(Tag, related_name='products', verbose_name=_("Tags"), blank=True)
    sku = models.CharField(_("SKU"), max_length=100, unique=True)
    price = models.DecimalField(_("Price"), max_digits=10, decimal_places=2)
    cost = models.DecimalField(_("Cost"), max_digits=10, decimal_places=2, validators=[MinValueValidator(0)])
    quantity_in_stock = models.PositiveIntegerField(_("Quantity in Stock"), default=0)

    # Images (up to 6 images)
    image_1 = models.ImageField(_("Image 1"), upload_to='products/images/', null=True, blank=True)
    image_2 = models.ImageField(_("Image 2"), upload_to='products/images/', null=True, blank=True)
    image_3 = models.ImageField(_("Image 3"), upload_to='products/images/', null=True, blank=True)
    image_4 = models.ImageField(_("Image 4"), upload_to='products/images/', null=True, blank=True)
    image_5 = models.ImageField(_("Image 5"), upload_to='products/images/', null=True, blank=True)
    image_6 = models.ImageField(_("Image 6"), upload_to='products/images/', null=True, blank=True)

    # Sustainability and origin information
    origin_country = models.CharField(_("Country of Origin"), max_length=50, blank=True)
    material_source = models.CharField(_("Material Source"), max_length=255, blank=True,
    ...
    carbon_footprint = models.DecimalField(
        ...
        help_text=_("Carbon footprint in kg CO2 equivalent for the product's lifecycle."),
        null=True,
        blank=True
    )
    lifecycle_assessment = models.TextField(
        ...
        blank=True,
        help_text=_("A description of the product's lifecycle, from raw material extraction to end-of-life.")
    )
    ...
    warranty_period = models.PositiveIntegerField(_("Warranty Period (months)"), default=0,
    ...
    # QR Code integration
    product_qr = models.OneToOneField(ProductQR, on_delete=models.SET_NULL, null=True, blank=True,
                                      related_name="product", verbose_name=_("Product QR Code"))
